...
function runCodeChunk(id, codeChunksData, runOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        const { headings, enableScriptExecution, filePath, fileDirectoryPath, imageFolderPath, latexEngine, modifySource, parseMD, resolveFilePath, } = runOptions;
...
function runAllCodeChunks(codeChunksData, runOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        const asyncFunctions = [];
...
exports.runAllCodeChunks = runAllCodeChunks;
