...
class MarkdownEngine {
    ...
    resetConfig() {
        ...
        this.config = Object.assign({}, markdown_engine_config_1.defaultMarkdownEngineConfig, this._originalConfig || {}, utility.configs.config || {});
        this.initConfig();
    }
    /**
     * Set default values
...
if (typeof(window['Reveal']) !== 'undefined') {
  ...
  WaveDrom.ProcessAll()
     ...
     */
    generateStylesForPreview(isPresentationMode = false, yamlConfig = {}) {
        let styles = '';
        // loading.css 
...
if (typeof(window['Reveal']) !== 'undefined') {
  ...
  mermaid.init(null, document.getElementsByClassName('mermaid'))
            ...
            // flowchart 
            let flowchartScript = ``, flowchartInitScript = ``;
...
for (var i = 0; i < flowcharts.length; i++) {
  ...
  try {
    ...
    flow.innerHTML = '<pre class="language-text">' + error.toString() + '</pre>'
            ...
            // sequence diagrams
            let sequenceDiagramScript = ``, sequenceDiagramStyle = ``, sequenceDiagramInitScript = ``;
      ...
      `;
            ...
            try {
                ...
                if (yamlConfig["isPresentationMode"]) {
                    styleCSS += yield utility.readFile(path.resolve(extensionDirectoryPath, `./styles/revealjs_theme/${(yamlConfig['presentation'] && typeof (yamlConfig['presentation']) === 'object' && yamlConfig['presentation']['theme']) ? yamlConfig['presentation']['theme'] : this.config.revealjsTheme}`), { encoding: 'utf-8' });
                }
                else {
                    // preview theme
  ...
  <html>
    ...
    chromeExport({ fileType = "pdf", runAllCodeChunks = false, openFileAfterGeneration = false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!puppeteer) {
                try {
                    const globalNodeModulesPath = (yield utility.execFile((process.platform === 'win32' ? 'npm.cmd' : 'npm'), ['root', '-g'])).trim().split('\n')[0].trim();
            ...
            const puppeteerConfig = Object.assign({ path: dest }, yamlConfig['isPresentationMode'] ? {} : {
                margin: {
                    top: '1cm',
                    bottom: '1cm',
                    left: '1cm',
    ...
    phantomjsExport({ fileType = "pdf", runAllCodeChunks = false, openFileAfterGeneration = false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const phantomjsConfig = Object.assign({ type: fileType, border: '1cm', quality: '75', script: path.join(extensionDirectoryPath, './dependencies/phantomjs/pdf_a4_portrait.js') }, (yield utility.getPhantomjsConfig()), yamlConfig['phantomjs'] || yamlConfig['phantom'] || {});
...
`;
    ...
    */
        ...
        */
        ...
        $('li').each((i, elem) => {
            ...
            if (attributeMatch = html.match(/<!--(.+?)-->/)) {
                ...
                let attrObj = attributes_1.parseAttributes(attributes);
    ...
    parseMD(inputString, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.runAllCodeChunks) {
                yield fenced_code_chunks_1.runAllCodeChunks(this.codeChunksData, this.generateRunOptions());
     ...
     */
    runAllCodeChunks() {
        return fenced_code_chunks_1.runAllCodeChunks(this.codeChunksData, this.generateRunOptions());
    }
    /**
     * legacy method to support backwards compatibility
     */
